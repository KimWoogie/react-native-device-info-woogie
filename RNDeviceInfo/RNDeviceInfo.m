...
//    NSLog(@"phoneNumber %@", phoneNumber);
    ...
    Xcode11 iPhone11계열 Simulator에서 Dictionary처리를 아래와 같이 해줘야 App Crash가 안된다.
    */
    NSDictionary * deviceInfoDictionary = [NSDictionary dictionaryWithObjectsAndKeys:
              currentDevice.systemName,@"systemName",
              currentDevice.systemVersion,@"systemVersion",
              phoneNumber,@"phoneNumber",
              self.deviceName,@"model",
